...
class Player():
    def __init__(self, device_index, colidables, tilesize, controllers, screen, upsizefaktorw, keyboard):
        ...
        self.idle = Spritesheet('src/assets/knight/Idle.png', (48, 64))
        self.run_right = Spritesheet('src/assets/knight/Run_right.png',(48, 64))
        self.run_left = Spritesheet('src/assets/knight/Run.png',(48, 64))
        self.attack = Spritesheet('src/assets/knight/Attack1.png',(64, 80))
        self.jumping = Spritesheet('src/assets/knight/Jump.png',(48, 64))
        self.hit = Spritesheet('src/assets/knight/Take Hit.png',(64, 64))
